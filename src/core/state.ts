import type { ExecutionStatus } from "../contracts/index.js";

export type TaskPhase = "accepted" | "preparing" | "running" | "awaiting_input" | "stopping" | "finalizing" | "terminal";
export type TaskState = { phase: TaskPhase; outcome?: ExecutionStatus; updated_at: string; reason?: string };

const allowed: Record<TaskPhase, readonly TaskPhase[]> = {
  accepted: ["preparing", "stopping", "finalizing"],
...
export function transition(state: TaskState, phase: TaskPhase, options: { outcome?: ExecutionStatus; reason?: string } = {}): TaskState {
